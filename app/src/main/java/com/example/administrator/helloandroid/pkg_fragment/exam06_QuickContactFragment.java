 ...
 */
public class exam06_QuickContactFragment extends DialogFragment {

    private PagerSlidingTabStrip tabs;
    private ViewPager pager;
    private ContactPagerAdapter adapter;

    public static exam06_QuickContactFragment newInstance() {
        exam06_QuickContactFragment f = new exam06_QuickContactFragment();
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(R.layout.activity_exam06_fragment_quick_contact, container, false);
