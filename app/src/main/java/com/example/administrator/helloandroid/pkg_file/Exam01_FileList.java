 ...
 */
public class Exam01_FileList extends ListView {

    public Exam01_FileList(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        init(context);
    }

    public Exam01_FileList(Context context, AttributeSet attrs) {
        super(context, attrs);

        init(context);
    }

    public Exam01_FileList(Context context) {
        super(context);
    ...
    // Event
    private Exam01_OnPathChangedListener _OnPathChangedListener = null;
    private Exam01_OnFileSelectedListener _OnFileSelectedListener = null;
    ...
    public void setOnPathChangedListener(Exam01_OnPathChangedListener value) {
        _OnPathChangedListener = value;
    }

    public Exam01_OnPathChangedListener getOnPathChangedListener() {
        return _OnPathChangedListener;
    }

    public void setOnFileSelected(Exam01_OnFileSelectedListener value) {
        _OnFileSelectedListener = value;
    }

    public Exam01_OnFileSelectedListener getOnFileSelected() {
