...
public class FloatingMenuLibrary_01_Exams extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_floating_menu_library_01__exams);
        ...
        findViewById(R.id.fab_edit).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getApplicationContext(), "어디로 갈까요", Toast.LENGTH_SHORT).show();
            }
        });
