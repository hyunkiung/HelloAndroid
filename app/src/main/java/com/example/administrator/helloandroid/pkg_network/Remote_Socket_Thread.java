 ...
 */
public class Remote_Socket_Thread {
    ...
    public static void main(String[] args) {
        new Remote_Socket_Thread().connect(null);
    }
    ...
    public void connect(Handler handler) {
        ...
        try {
            ...
            mReceiveThread = new ClientReciver(mSocket, "현기웅", handler);
            mReceiveThread.start();
            makeMessage(99, "서버에 접속되었습니다. : " + SERVER_HOST);
        } catch (UnknownHostException e) {
            e.printStackTrace();
        } catch (IOException e) {
            e.printStackTrace();
            makeMessage(100, "서버 접속 에러입니다. 서버를 가동해주세요.");
        }
    }
    ...
    class ClientReciver extends Thread {
        ...
        public ClientReciver(Socket socket, String nickName, Handler handler) {
            try {
                ...
                resultMessage = "id : " + nickName + " 접속 완료";
