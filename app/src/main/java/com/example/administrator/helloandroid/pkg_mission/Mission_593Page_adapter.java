 ...
 */
public class Mission_593Page_adapter extends BaseAdapter {
    ...
    // 이 생성자가 자동으로 안생겼다.
    public Mission_593Page_adapter(Context context, List<Calendar> list) {
        mContext = context;
        mList = list;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.activity_grid_view_calendar_cell2, null);
